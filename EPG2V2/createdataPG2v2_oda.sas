...
*************************************************************/
%let path=/home/&sysuserid/EPG2V2;
...
%let url=%str(http://dl.liveweb.sas.com/eldata/pg2v2_oda.zip);
...
%unpack(%superq(path),epg2v2.zip,epg2v2)

/* added to set &path for elearning */
%let path=/home/&sysuserid/EPG2V2/data;
